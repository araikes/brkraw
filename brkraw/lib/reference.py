    ...
    dict(Manufacturer                   = 'VisuManufacturer',
         ...
         SliceEncodingDirection         = [dict(key         = 'VisuAcqGradEncoding',
                                           ...
                                           dict(EncSeq      = 'VisuAcqGradEncoding',
                                                Equation    = 'len(EncSeq)')],
         SliceThickness                 = 'VisuCoreFrameThickness',
